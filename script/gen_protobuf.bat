...
protoc-3.19.2.exe --proto_path=../engine/codec/proto/rpc_client --proto_path=../engine/codec/proto/google  --csharp_out=../sdks/unity/ProtoGen/ ../engine/codec/proto/rpc_client/*.proto
