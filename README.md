...
近年来，国内开始通过发版号来限制游戏在国内的上线，各个公司的游戏因为没有版号，开始将游戏的目标市场转向海外。相应的，游戏服务也开始全球化部署，各个游戏开始逐渐上公有云(如google云)，但之前由于游戏产品对延时很敏感，之前游戏服务器很少使用云组件进行开发与部署，因此Wind使用kubernetes部署并在服务层接入云组件来保证服务在云上的自动伸缩，有效的分配云上公共资源，提高服务资源的利用率。
